...
core_apps=$(echo "python2.7 python-dev python-setuptools build-essential libxml2-dev libxslt1-dev libffi-dev graphviz libpq-dev libssl-dev zlib1g-dev")
...
echo && echo -e $(tput setaf 6)"!!-- End of Python2.7 and development apps installation."$(tput sgr0)
